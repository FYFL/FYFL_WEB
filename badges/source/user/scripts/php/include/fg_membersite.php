...
class FGMembersite
{
    ...
    function CollectRegistrationSubmission(&$formvars)
    {
	    ...
	    $formvars['Adult'] = $this->Sanitize($_POST['Adult']);
        $formvars['username'] = $this->Sanitize($_POST['username']);
        $formvars['password'] = $this->Sanitize($_POST['password']);
        $formvars['State'] = $this->Sanitize($_POST['State']);
        $formvars['County'] = $this->Sanitize($_POST['County']);
	    $formvars['user_level'] = $this->Sanitize($_POST['user_level']);
	
  		$formvars['lname'] = $this->Sanitize($_POST['lname']);
		$formvars['parentemail'] = $this->Sanitize($_POST['parentemail']);
    }
